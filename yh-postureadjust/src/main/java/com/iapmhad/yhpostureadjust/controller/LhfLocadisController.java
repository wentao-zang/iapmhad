 ...
 */
@RestController
@RequestMapping("yhpostureadjust/lhflocadis")
public class LhfLocadisController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("yhpostureadjust:lhflocadis:list")
    ...
    //@RequiresPermissions("yhpostureadjust:lhflocadis:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("yhpostureadjust:lhflocadis:save")
    ...
    //@RequiresPermissions("yhpostureadjust:lhflocadis:update")
    ...
    //@RequiresPermissions("yhpostureadjust:lhflocadis:delete")
