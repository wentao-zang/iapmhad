    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rxbasestan/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rxBasestan.aircraftId
                this.dataForm.flightId = data.rxBasestan.flightId
                this.dataForm.fixtureId = data.rxBasestan.fixtureId
                this.dataForm.basesx1 = data.rxBasestan.basesx1
                this.dataForm.basesz1 = data.rxBasestan.basesz1
                this.dataForm.basesx2 = data.rxBasestan.basesx2
                this.dataForm.basesz2 = data.rxBasestan.basesz2
                this.dataForm.basesx3 = data.rxBasestan.basesx3
                this.dataForm.basesz3 = data.rxBasestan.basesz3
                this.dataForm.basesx4 = data.rxBasestan.basesx4
                this.dataForm.basesz4 = data.rxBasestan.basesz4
                this.dataForm.basesx5 = data.rxBasestan.basesx5
                this.dataForm.basesz5 = data.rxBasestan.basesz5
                this.dataForm.basesqusx = data.rxBasestan.basesqusx
                this.dataForm.basesqusz = data.rxBasestan.basesqusz
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rxbasestan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
