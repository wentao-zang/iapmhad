<template>
  <el-dialog
    ...
    <el-form-item label="" prop="locaz1">
      <el-input v-model="dataForm.locaz1" placeholder=""></el-input>
    </el-form-item>
    ...
    <el-form-item label="" prop="locaz2">
      <el-input v-model="dataForm.locaz2" placeholder=""></el-input>
    </el-form-item>
    ...
    <el-form-item label="" prop="locaz3">
      <el-input v-model="dataForm.locaz3" placeholder=""></el-input>
    </el-form-item>
    ...
    <el-form-item label="" prop="locaz4">
      <el-input v-model="dataForm.locaz4" placeholder=""></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/lslocadis1/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.lsLocadis1.aircraftId
                this.dataForm.flightId = data.lsLocadis1.flightId
                this.dataForm.fixtureId = data.lsLocadis1.fixtureId
                this.dataForm.locax1 = data.lsLocadis1.locax1
                this.dataForm.locay1 = data.lsLocadis1.locay1
                this.dataForm.locaz1 = data.lsLocadis1.locaz1
                this.dataForm.locax2 = data.lsLocadis1.locax2
                this.dataForm.locay2 = data.lsLocadis1.locay2
                this.dataForm.locaz2 = data.lsLocadis1.locaz2
                this.dataForm.locax3 = data.lsLocadis1.locax3
                this.dataForm.locay3 = data.lsLocadis1.locay3
                this.dataForm.locaz3 = data.lsLocadis1.locaz3
                this.dataForm.locax4 = data.lsLocadis1.locax4
                this.dataForm.locay4 = data.lsLocadis1.locay4
                this.dataForm.locaz4 = data.lsLocadis1.locaz4
                this.dataForm.time = data.lsLocadis1.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/lslocadis1/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
