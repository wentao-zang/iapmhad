    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rqlocadis/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rqLocadis.aircraftId
                this.dataForm.flightId = data.rqLocadis.flightId
                this.dataForm.fixtureId = data.rqLocadis.fixtureId
                this.dataForm.locax1 = data.rqLocadis.locax1
                this.dataForm.locay1 = data.rqLocadis.locay1
                this.dataForm.locax2 = data.rqLocadis.locax2
                this.dataForm.locay2 = data.rqLocadis.locay2
                this.dataForm.locax3 = data.rqLocadis.locax3
                this.dataForm.locay3 = data.rqLocadis.locay3
                this.dataForm.locax4 = data.rqLocadis.locax4
                this.dataForm.locay4 = data.rqLocadis.locay4
                this.dataForm.locax5 = data.rqLocadis.locax5
                this.dataForm.locay5 = data.rqLocadis.locay5
                this.dataForm.locax6 = data.rqLocadis.locax6
                this.dataForm.locapz1 = data.rqLocadis.locapz1
                this.dataForm.locapz2 = data.rqLocadis.locapz2
                this.dataForm.time = data.rqLocadis.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rqlocadis/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
