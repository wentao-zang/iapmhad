    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rqlocastan/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rqLocastan.aircraftId
                this.dataForm.flightId = data.rqLocastan.flightId
                this.dataForm.fixtureId = data.rqLocastan.fixtureId
                this.dataForm.locasx1 = data.rqLocastan.locasx1
                this.dataForm.locasy1 = data.rqLocastan.locasy1
                this.dataForm.locasx2 = data.rqLocastan.locasx2
                this.dataForm.locasy2 = data.rqLocastan.locasy2
                this.dataForm.locasx3 = data.rqLocastan.locasx3
                this.dataForm.locasy3 = data.rqLocastan.locasy3
                this.dataForm.locasx4 = data.rqLocastan.locasx4
                this.dataForm.locasy4 = data.rqLocastan.locasy4
                this.dataForm.locasx5 = data.rqLocastan.locasx5
                this.dataForm.locasy5 = data.rqLocastan.locasy5
                this.dataForm.locasx6 = data.rqLocastan.locasx6
                this.dataForm.locapsz1 = data.rqLocastan.locapsz1
                this.dataForm.locapsz2 = data.rqLocastan.locapsz2
                this.dataForm.time = data.rqLocastan.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rqlocastan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
