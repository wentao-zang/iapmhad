    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rslocadis1/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rsLocadis1.aircraftId
                this.dataForm.flightId = data.rsLocadis1.flightId
                this.dataForm.fixtureId = data.rsLocadis1.fixtureId
                this.dataForm.locax1 = data.rsLocadis1.locax1
                this.dataForm.locay1 = data.rsLocadis1.locay1
                this.dataForm.locaz1 = data.rsLocadis1.locaz1
                this.dataForm.locax2 = data.rsLocadis1.locax2
                this.dataForm.locay2 = data.rsLocadis1.locay2
                this.dataForm.locaz2 = data.rsLocadis1.locaz2
                this.dataForm.locax3 = data.rsLocadis1.locax3
                this.dataForm.locay3 = data.rsLocadis1.locay3
                this.dataForm.locaz3 = data.rsLocadis1.locaz3
                this.dataForm.locax4 = data.rsLocadis1.locax4
                this.dataForm.locay4 = data.rsLocadis1.locay4
                this.dataForm.locaz4 = data.rsLocadis1.locaz4
                this.dataForm.time = data.rsLocadis1.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rslocadis1/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
