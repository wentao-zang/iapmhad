    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/lxbasestan/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.lxBasestan.aircraftId
                this.dataForm.flightId = data.lxBasestan.flightId
                this.dataForm.fixtureId = data.lxBasestan.fixtureId
                this.dataForm.basesx1 = data.lxBasestan.basesx1
                this.dataForm.basesz1 = data.lxBasestan.basesz1
                this.dataForm.basesx2 = data.lxBasestan.basesx2
                this.dataForm.basesz2 = data.lxBasestan.basesz2
                this.dataForm.basesx3 = data.lxBasestan.basesx3
                this.dataForm.basesz3 = data.lxBasestan.basesz3
                this.dataForm.basesx4 = data.lxBasestan.basesx4
                this.dataForm.basesz4 = data.lxBasestan.basesz4
                this.dataForm.basesx5 = data.lxBasestan.basesx5
                this.dataForm.basesz5 = data.lxBasestan.basesz5
                this.dataForm.basesqusx = data.lxBasestan.basesqusx
                this.dataForm.basesqusz = data.lxBasestan.basesqusz
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/lxbasestan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
