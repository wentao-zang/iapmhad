    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rsbasestan/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rsBasestan.aircraftId
                this.dataForm.flightId = data.rsBasestan.flightId
                this.dataForm.fixtureId = data.rsBasestan.fixtureId
                this.dataForm.basesx1 = data.rsBasestan.basesx1
                this.dataForm.basesz1 = data.rsBasestan.basesz1
                this.dataForm.basesx2 = data.rsBasestan.basesx2
                this.dataForm.basesz2 = data.rsBasestan.basesz2
                this.dataForm.basesx3 = data.rsBasestan.basesx3
                this.dataForm.basesz3 = data.rsBasestan.basesz3
                this.dataForm.basesx4 = data.rsBasestan.basesx4
                this.dataForm.basesz4 = data.rsBasestan.basesz4
                this.dataForm.basesx5 = data.rsBasestan.basesx5
                this.dataForm.basesz5 = data.rsBasestan.basesz5
                this.dataForm.basesqusx = data.rsBasestan.basesqusx
                this.dataForm.basesqusz = data.rsBasestan.basesqusz
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rsbasestan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
