    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rxlocadis1/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rxLocadis1.aircraftId
                this.dataForm.flightId = data.rxLocadis1.flightId
                this.dataForm.fixtureId = data.rxLocadis1.fixtureId
                this.dataForm.locax1 = data.rxLocadis1.locax1
                this.dataForm.locay1 = data.rxLocadis1.locay1
                this.dataForm.locaz1 = data.rxLocadis1.locaz1
                this.dataForm.locax2 = data.rxLocadis1.locax2
                this.dataForm.locay2 = data.rxLocadis1.locay2
                this.dataForm.locaz2 = data.rxLocadis1.locaz2
                this.dataForm.locax3 = data.rxLocadis1.locax3
                this.dataForm.locay3 = data.rxLocadis1.locay3
                this.dataForm.locaz3 = data.rxLocadis1.locaz3
                this.dataForm.locax4 = data.rxLocadis1.locax4
                this.dataForm.locay4 = data.rxLocadis1.locay4
                this.dataForm.locaz4 = data.rxLocadis1.locaz4
                this.dataForm.time = data.rxLocadis1.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/yhpostureadjust/rxlocadis1/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
