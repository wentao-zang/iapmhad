    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/jylocastan/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.jyLocastan.aircraftId
                this.dataForm.flightId = data.jyLocastan.flightId
                this.dataForm.fixtureId = data.jyLocastan.fixtureId
                this.dataForm.locasx1 = data.jyLocastan.locasx1
                this.dataForm.locasy1 = data.jyLocastan.locasy1
                this.dataForm.locasz1 = data.jyLocastan.locasz1
                this.dataForm.locasx2 = data.jyLocastan.locasx2
                this.dataForm.locasy2 = data.jyLocastan.locasy2
                this.dataForm.locasz2 = data.jyLocastan.locasz2
                this.dataForm.locasx3 = data.jyLocastan.locasx3
                this.dataForm.locasy3 = data.jyLocastan.locasy3
                this.dataForm.locasz3 = data.jyLocastan.locasz3
                this.dataForm.locasx4 = data.jyLocastan.locasx4
                this.dataForm.locasy4 = data.jyLocastan.locasy4
                this.dataForm.locasz4 = data.jyLocastan.locasz4
                this.dataForm.time = data.jyLocastan.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/jylocastan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
