    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/lwlocastan/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.lwLocastan.aircraftId
                this.dataForm.flightId = data.lwLocastan.flightId
                this.dataForm.fixtureId = data.lwLocastan.fixtureId
                this.dataForm.locasx1 = data.lwLocastan.locasx1
                this.dataForm.locasy1 = data.lwLocastan.locasy1
                this.dataForm.locasz1 = data.lwLocastan.locasz1
                this.dataForm.locasx2 = data.lwLocastan.locasx2
                this.dataForm.locasy2 = data.lwLocastan.locasy2
                this.dataForm.locasz2 = data.lwLocastan.locasz2
                this.dataForm.locasx3 = data.lwLocastan.locasx3
                this.dataForm.locasy3 = data.lwLocastan.locasy3
                this.dataForm.locasz3 = data.lwLocastan.locasz3
                this.dataForm.locasx4 = data.lwLocastan.locasx4
                this.dataForm.locasy4 = data.lwLocastan.locasy4
                this.dataForm.locasz4 = data.lwLocastan.locasz4
                this.dataForm.time = data.lwLocastan.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/lwlocastan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
