    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/rwlocadis/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rwLocadis.aircraftId
                this.dataForm.flightId = data.rwLocadis.flightId
                this.dataForm.fixtureId = data.rwLocadis.fixtureId
                this.dataForm.locax1 = data.rwLocadis.locax1
                this.dataForm.locay1 = data.rwLocadis.locay1
                this.dataForm.locaz1 = data.rwLocadis.locaz1
                this.dataForm.locax2 = data.rwLocadis.locax2
                this.dataForm.locay2 = data.rwLocadis.locay2
                this.dataForm.locaz2 = data.rwLocadis.locaz2
                this.dataForm.locax3 = data.rwLocadis.locax3
                this.dataForm.locay3 = data.rwLocadis.locay3
                this.dataForm.locaz3 = data.rwLocadis.locaz3
                this.dataForm.locax4 = data.rwLocadis.locax4
                this.dataForm.locay4 = data.rwLocadis.locay4
                this.dataForm.locaz4 = data.rwLocadis.locaz4
                this.dataForm.time = data.rwLocadis.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/rwlocadis/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
