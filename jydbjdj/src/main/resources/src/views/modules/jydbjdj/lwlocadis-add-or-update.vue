    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/lwlocadis/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.lwLocadis.aircraftId
                this.dataForm.flightId = data.lwLocadis.flightId
                this.dataForm.fixtureId = data.lwLocadis.fixtureId
                this.dataForm.locax1 = data.lwLocadis.locax1
                this.dataForm.locay1 = data.lwLocadis.locay1
                this.dataForm.locaz1 = data.lwLocadis.locaz1
                this.dataForm.locax2 = data.lwLocadis.locax2
                this.dataForm.locay2 = data.lwLocadis.locay2
                this.dataForm.locaz2 = data.lwLocadis.locaz2
                this.dataForm.locax3 = data.lwLocadis.locax3
                this.dataForm.locay3 = data.lwLocadis.locay3
                this.dataForm.locaz3 = data.lwLocadis.locaz3
                this.dataForm.locax4 = data.lwLocadis.locax4
                this.dataForm.locay4 = data.lwLocadis.locay4
                this.dataForm.locaz4 = data.lwLocadis.locaz4
                this.dataForm.time = data.lwLocadis.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/lwlocadis/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
