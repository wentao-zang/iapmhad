    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/rwlocastan/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.aircraftId = data.rwLocastan.aircraftId
                this.dataForm.flightId = data.rwLocastan.flightId
                this.dataForm.fixtureId = data.rwLocastan.fixtureId
                this.dataForm.locasx1 = data.rwLocastan.locasx1
                this.dataForm.locasy1 = data.rwLocastan.locasy1
                this.dataForm.locasz1 = data.rwLocastan.locasz1
                this.dataForm.locasx2 = data.rwLocastan.locasx2
                this.dataForm.locasy2 = data.rwLocastan.locasy2
                this.dataForm.locasz2 = data.rwLocastan.locasz2
                this.dataForm.locasx3 = data.rwLocastan.locasx3
                this.dataForm.locasy3 = data.rwLocastan.locasy3
                this.dataForm.locasz3 = data.rwLocastan.locasz3
                this.dataForm.locasx4 = data.rwLocastan.locasx4
                this.dataForm.locasy4 = data.rwLocastan.locasy4
                this.dataForm.locasz4 = data.rwLocastan.locasz4
                this.dataForm.time = data.rwLocastan.time
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/jydbjdj/rwlocastan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
